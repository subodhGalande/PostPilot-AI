          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="font-heading text-xl font-semibold text-muted-foreground">The Old Way</h3>
              </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="font-heading text-xl font-semibold text-foreground">The PostPilot Way</h3>
                </div>
