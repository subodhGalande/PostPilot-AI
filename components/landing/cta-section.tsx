        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 text-pretty tracking-tight">
              Join creators who are saving hours every week by generating
              high-quality, perfectly formatted posts in seconds.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                asChild
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-10 h-14 text-lg shadow-lg shadow-primary/20 w-full sm:w-auto"
              >
                <Link href="/signup">
