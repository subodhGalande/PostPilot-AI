...
const faqs = [
  {
    ...
    answer:
      "Currently, PostPilot is highly optimized for generating content specifically tailored for X (formerly Twitter) and LinkedIn. We focus deeply on the unique formats, constraints, and cultures of these two platforms.",
  },
  {
    question: "Does PostPilot automatically schedule my posts?",
    answer:
      "No. PostPilot is a pure generation and management tool. We believe you should retain full control over your posting schedule. Once you're happy with a generated post, you can easily copy and paste it into your preferred publishing tool or directly into the social platforms.",
  },
  {
    question: "How much does it cost?",
    answer:
      "PostPilot is currently free to use! Every user gets a daily allowance of 10 generation tokens to create posts for X and LinkedIn. Your tokens reset every single day.",
  },
  {
    question: "Can I manage my generated posts?",
    answer:
      "Yes, you have a built-in workspace where you can save drafts, view your generated content on a visual calendar layout, and refine them until they are ready to publish.",
  },
];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div className="md:w-2/3">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground font-normal leading-relaxed max-w-xl [text-wrap:pretty] tracking-tight">
              Everything you need to know about the product, platform support,
              and how the generation engine works.
            </p>
          </div>
          <div>
            <Button
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="font-semibold text-foreground text-lg group-hover:text-primary transition-colors text-balance pr-8">
                  {faq.question}
                </span>
                <ChevronDown
