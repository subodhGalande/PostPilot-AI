  ...
  },
  {
    ...
    visual: (
      <div className="flex-1 w-full bg-white/20 rounded-t-xl border-t border-x border-white/30 p-6 flex flex-col justify-center items-center mt-6 mx-6 mb-0 text-center border-b-0 rounded-b-none backdrop-blur-sm">
         <div className="text-5xl font-bold text-white mb-1 tracking-tighter">10<span className="text-2xl text-white/60 font-normal">/10</span></div>
         <div className="text-xs font-semibold text-white/80 mt-2 tracking-widest uppercase">Tokens Available</div>
