          ...
          {themeOptions.map((option) => {
            ...
            return (
              <Label
                ...
                className="flex cursor-pointer flex-col items-center gap-3 rounded-xl border border-input p-4 transition-all duration-300 hover:bg-accent/50 has-[[data-state=checked]]:border-primary has-[[data-state=checked]]:bg-primary/5 has-[[data-state=checked]]:shadow-sm"
              >
                <RadioGroupItem
                  value={option.value}
