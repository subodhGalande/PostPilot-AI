  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-xl rounded-3xl bg-white/5 border border-white/10 backdrop-blur-2xl p-10 shadow-[0_24px_48px_-12px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] transition-transform duration-700 ease-out hover:-translate-y-2 hover:bg-white/10">
        <h2 className="text-4xl md:text-5xl font-medium tracking-tight text-white mb-6 leading-tight">Build your audience<br />on autopilot.</h2>
        <p className="text-lg text-white/70 leading-relaxed">Generate, schedule, and publish high-quality posts that resonate with your followers across multiple platforms.</p>
      </div>
    </div>
  );
}
