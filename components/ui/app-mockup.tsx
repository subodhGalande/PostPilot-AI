            ...
            <div className="rounded-xl border border-sidebar-border/40 bg-sidebar-accent/20 px-3 py-2.5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-sidebar-foreground/80">
                  6<span className="text-xs font-normal text-sidebar-foreground/45">/10</span>
                </span>
              </div>
           ...
           <div className="flex-1 rounded-xl border bg-card text-card-foreground shadow-sm flex flex-col">
             ...
             <div className="flex-1 flex flex-col">
               ...
               <div className="grid grid-cols-7 flex-1">
                 {/* Week 1 */}
                 <div className="border-r border-b border-border/50 p-1 relative flex flex-col gap-1 text-muted-foreground bg-muted/20 text-xs text-right pr-2 pt-2">27</div>
                 ...
                 <div className="border-r border-b border-border/50 p-1 relative flex flex-col gap-1 text-muted-foreground bg-muted/20 text-xs text-right pr-2 pt-2">29</div>
                 <div className="border-r border-b border-border/50 p-1 relative flex flex-col gap-1 text-muted-foreground bg-muted/20 text-xs text-right pr-2 pt-2">30</div>
                 ...
                 <div className="border-b border-border/50 p-1 relative flex flex-col gap-1 font-medium text-xs text-right pr-2 pt-2">3</div>

                 {/* Week 2 */}
                 <div className="border-r border-b border-border/50 p-1 relative flex flex-col gap-1 font-medium text-xs text-right pr-2 pt-2">4</div>
                 <div className="border-r border-b border-border/50 p-1 relative flex flex-col gap-1 font-medium text-xs text-right pr-2 pt-2">
                   5
                   <div className="mt-1 group flex w-full flex-col gap-1.5 rounded-lg border p-1.5 text-left text-card-foreground shadow-sm bg-slate-100/70 border-slate-300/50">
                     <div className="flex w-full items-center justify-between gap-1.5">
                 ...
                 <div className="border-r border-b border-border/50 p-1 relative flex flex-col gap-1 font-medium text-xs text-right pr-2 pt-2">8</div>
                 <div className="border-r border-b border-border/50 p-1 relative flex flex-col gap-1 font-medium bg-blue-50/30 text-blue-600 text-xs text-right pr-2 pt-2">
                    <span className="w-5 h-5 rounded-full bg-primary text-primary-foreground flex items-center justify-center self-end">9</span>
                 </div>
                 <div className="border-b border-border/50 p-1 relative flex flex-col gap-1 font-medium text-xs text-right pr-2 pt-2">10</div>
               </div>
             </div>
           </div>
        </div>
