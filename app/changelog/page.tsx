...
export const metadata: Metadata = {
  ...
  description:
    "New features, updates, and improvements shipped to PostPilot AI.",
};
...
const releases: Release[] = [
  {
    ...
    description:
      "The initial release of PostPilot AI—bringing raw idea transformation, instant multi-channel social drafting, and visual content scheduling.",
    changes: [
      {
        type: "added",
...
function TypeTag({ type }: { type: ChangelogItem["type"] }) {
  switch (type) {
    case "added":
      return (
        <span className="text-[11px] font-mono text-emerald-400/90 font-medium uppercase tracking-wider shrink-0 mt-0.5">
          Added
        </span>
      );
    case "improved":
      return (
        <span className="text-[11px] font-mono text-primary/90 font-medium uppercase tracking-wider shrink-0 mt-0.5">
          Improved
        </span>
      );
    case "fixed":
      return (
        <span className="text-[11px] font-mono text-amber-400/90 font-medium uppercase tracking-wider shrink-0 mt-0.5">
          Fixed
        </span>
      );
  }
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-16">
            {releases.map((release) => (
              <article
                key={release.version}
                className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 pt-6 border-t border-white/5 first:border-0 first:pt-0"
              >
